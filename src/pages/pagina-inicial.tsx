    ...
    return (
        <div style={{ background: dark ? "linear-gradient(to bottom right, #0d1015, #080c14)" : "linear-gradient(to bottom right, #f7fbff, #fdfeff)" }}>
            {menuAberto ?
                ...
                :
                <>
                    <header id="header" className={`relative flex flex-col min-h-[120vh] border-b ${dark ? 'border-b-slate-600/20' : 'border-b-slate-400/20'}`}>
                        ...
                        {!clubes &&
                            <>
                                ...
                                <p key={valorCuriosidade} className={`animacao-entrada font-mono text-center mt-12 translate-y-[150%] ${dark && 'text-slate-200'}`}>{curiosidadesFinanceiras[valorCuriosidade]}</p>
                    ...
                    <section style={{ background: dark ? "linear-gradient(to bottom right, #0d1015, #080c14)" : "linear-gradient(to bottom right, #f7fbff, #fdfeff)" }} id="topicos" className="flex flex-col mt-14">
                        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
                            <div className="max-w-2xl mb-16">
                                ...
                                <h2 className={`text-3xl sm:text-4xl lg:text-5xl font- leading-tight mb-6 ${dark ? 'text-white' : 'text-[#222222]'}`}>
                                    ...
                                    <div className="flex items-start gap-5">
                                        ...
                                        {topicoEscolhido === botao.key && (
                                            ...
                                            <div className="flex items-baseline gap-3">
                                                <span className={`text-3xl font-bold ${dark ? 'text-amber-400' : 'text-amber-500'}`}>
                                                {botao.subTopico[0]}
                                                </span>
                                                <span className={`text-sm ${dark ? 'text-white/30' : 'text-black/40'}`}>
                                                {botao.subTopico[1]}
                                                </span>
                                            </div>
                                            </div>
                    ...
                    <section style={{ background: dark ? "linear-gradient(to bottom right, #0d1015, #080c14)" : "linear-gradient(to bottom right, #f7fbff, #fdfeff)" }} className="relative py-24 sm:py-32 overflow-hidden">
                        ...
                        <div className="relative z-10 max-w-4xl mx-auto px-6 lg:px-8 text-center">
                            ...
                            <h2 className={`text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight mb-6 ${dark ? 'text-white' : 'text-[#222222]/92'}`}>
                    ...
                    <footer className="relative bg-[#060911] border-t border-white/4">
                        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16 sm:py-20">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8">
                                ...
                                <div className="lg:col-span-2">
                                    ...
                                    <a href="/" className="flex items-center gap-3 mb-5">
                                        ...
                                        <span className="text-lg font-semibold text-white tracking-tight">
                                            Finanças<span className="text-amber-400">FC</span>
                                        </span>
                                    </a>
                                ...
                                <div>
                                    <h4 className="text-sm font-medium text-white/50 mb-5 uppercase tracking-wide">Análises</h4>
                                    <ul className="space-y-3">
                                        <li><a href="#revenue" className="text-sm text-white/25 hover:text-white/60 transition-colors duration-200">Faturamento</a></li>
                                        <li><a href="#debt" className="text-sm text-white/25 hover:text-white/60 transition-colors duration-200">Dívidas</a></li>
                                        <li><a href="#cost" className="text-sm text-white/25 hover:text-white/60 transition-colors duration-200">Custo da Vitória</a></li>
                                        <li><a href="#compare" className="text-sm text-white/25 hover:text-white/60 transition-colors duration-200">Comparar Clubes</a></li>
                                    </ul>
                                </div>

                                <div>
                                    <h4 className="text-sm font-medium text-white/50 mb-5 uppercase tracking-wide">Clubes</h4>
                                    <ul className="space-y-3">
                                        <li><a href="#" className="text-sm text-white/25 hover:text-white/60 transition-colors duration-200">Série A</a></li>
                                        <li><a href="#" className="text-sm text-white/25 hover:text-white/60 transition-colors duration-200">Série B</a></li>
                                        <li><a href="#" className="text-sm text-white/25 hover:text-white/60 transition-colors duration-200">Ranking</a></li>
                                        <li><a href="#" className="text-sm text-white/25 hover:text-white/60 transition-colors duration-200">Histórico</a></li>
                                    </ul>
                                </div>

                                <div>
                                    <h4 className="text-sm font-medium text-white/50 mb-5 uppercase tracking-wide">Sobre</h4>
                                    <ul className="space-y-3">
                                        <li><a href="#" className="text-sm text-white/25 hover:text-white/60 transition-colors duration-200">Metodologia</a></li>
                                        <li><a href="#" className="text-sm text-white/25 hover:text-white/60 transition-colors duration-200">Fontes dos Dados</a></li>
                                        <li><a href="#" className="text-sm text-white/25 hover:text-white/60 transition-colors duration-200">Contato</a></li>
                                        <li><a href="#" className="text-sm text-white/25 hover:text-white/60 transition-colors duration-200">FAQ</a></li>
                                    </ul>
                                </div>
                            ...
                            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                                <p className="text-xs text-white/20">
                                    © 2026 FinançasFC. Todos os direitos reservados.
                                </p>
