...
export default function CardProduto() {
    ...
    return (
        <div className="absolute z-999 bg-white top-1/2 left-1/2 -translate-1/2 p-8 max-w-4/5 min-w-4/5 min-h-70 max-h-70 rounded-2xl sm:min-w-120 sm:max-w-120">
            ...
            <div className="mt-6 rounded-sm p-2 flex flex-col justify-between gap-3">
                <button onClick={() => {
                    ...
                    }} className="bg-linear-to-br to-[#245cc0] from-[#3f7fe9] rounded-md py-1 min-h-11 max-h-11 text-slate-50 font-medium shadow-[1px_1px_1px_#0000002a] cursor-pointer flex items-center justify-center text-sm">
                ...
                <button onClick={() => {
                    ...
                    setMostrarCard(false);
                    }} className="bg-linear-to-br rounded-md text-[#222222] font-medium border border-zinc-800/30 cursor-pointer flex items-center justify-center text-xs py-1 max-h-11 min-h-11">
