  ...
  return (
    <div className="[--shadow:rgba(60,64,67,0.3)_0_1px_2px_0,rgba(60,64,67,0.15)_0_2px_6px_2px] min-w-full transition-all duration-100 rounded-2xl bg-[#634647] [box-shadow:var(--shadow)] max-w-full">
      <div className="flex flex-col items-center justify-between pt-9 px-6 pb-6 relative">
        ...
        <h5 className="font-semibold mb-2 text-left mr-auto text-zinc-50">
          Sua privacidade é importante para nós
        </h5>

        <p className="w-full mb-4 text-sm text-zinc-300 text-justify">
            Processamos suas informações pessoais para medir e melhorar nossos sites e serviços, para auxiliar nossas campanhas e para fornecer conteúdo personalizado.
          <br />
          Para mais informações, veja a nossa{" "}
          <a onClick={() => handleNavegar('politica-de-privacidade')} className="mb-2 text-sm cursor-pointer font-semibold transition-colors hover:text-[#eab789] underline underline-offset-2">
        ...
        <button
          ...
          className="absolute font-semibold right-6 bottom-6 cursor-pointer py-2 px-8 w-max break-keep rounded-lg transition-colors duration-100 text-[#453535] bg-[#eab789] hover:bg-[#fcbf8a]"
          type="button"
        >
          Aceitar
        </button>
